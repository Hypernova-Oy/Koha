...
-->
 ...
 <role>
 <roleTerm authority="marcrelator" type="text">tekijä</roleTerm>
 </role>
 ...
 <name>
 <xsl:if test="@ind1=1">
 <xsl:attribute name="type"><xsl:text>henkilökohtainen</xsl:text></xsl:attribute>
 </xsl:if>
 <namePart>
 ...
 <xsl:attribute name="collection">kyllä</xsl:attribute>
 </xsl:if>
 <xsl:if test="$leader6='d' or $leader6='f' or $leader6='p' or $leader6='t'">
 <xsl:attribute name="manuscript">kyllä</xsl:attribute>
 </xsl:if>
 <xsl:choose>
 <xsl:when test="$leader6='a' or $leader6='t'">teksti</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'">kartta-aineisto</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'">Musiikkinotaatio</xsl:when>
 <xsl:when test="$leader6='i'">puheäänite</xsl:when>
 <xsl:when test="$leader6='j'">musiikkiäänite</xsl:when>
 <xsl:when test="$leader6='k'">valokuva</xsl:when>
 <xsl:when test="$leader6='g'">liikkuva kuva</xsl:when>
 <xsl:when test="$leader6='r'">kolmiulotteinen esine</xsl:when>
 <xsl:when test="$leader6='m'">tietokoneohjelma, multimedia</xsl:when>
 <xsl:when test="$leader6='p'">sekalainen aineisto</xsl:when>
 </xsl:choose>
 </typeOfResource>
 <xsl:if test="substring($controlField008,26,1)='d'">
 <genre authority="marc">karttapallo</genre>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='r']">
 <genre authority="marc">kaukokartoituskuva</genre>
 </xsl:if>
 ...
 <genre authority="marc">tietokanta</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='l'">
 <genre authority="marc">irtolehtinen</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='m'">
 <genre authority="marc">sarja</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='n'">
 <genre authority="marc">sanomalehti</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='p'">
 <genre authority="marc">aikakauslehti</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='w'">
 <genre authority="marc">verkkosivusto</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">tiivistelmä tai lyhennelmä</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'b')">
 <genre authority="marc">bibliografia</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'c')">
 <genre authority="marc">kokoelma</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'d')">
 <genre authority="marc">sanakirja, sanasto</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'e')">
 <genre authority="marc">tietosanakirja</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'f')">
 <genre authority="marc">käsikirja</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'g')">
 <genre authority="marc">artikla, pykälä</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'i')">
 <genre authority="marc">hakemisto</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'k')">
 <genre authority="marc">diskografia</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'l')">
 <genre authority="marc">laki, säädös</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'m')">
 <genre authority="marc">väitöskirjat, tai muut opinnäytteet</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'n')">
 <genre authority="marc">kirjallisuuskatsaus</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'o')">
 <genre authority="marc">arvostelu</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'p')">
 <genre authority="marc">ohjelmoidut tekstit</genre>
 </xsl:when>
 ...
 <genre authority="marc">tilastot</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'t')">
 <genre authority="marc">tekninen raportti</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'v')">
 <genre authority="marc">oikeustapauskeskustelu</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'w')">
 <genre authority="marc">tuomioistuinpäätös</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'z')">
 <genre authority="marc">sopimus</genre>
 </xsl:when>
 </xsl:choose>
 <xsl:variable name="controlField008-29" select="substring($controlField008,30,1)"/>
 <xsl:choose>
 <xsl:when test="$controlField008-29='1'">
 <genre authority="marc">kokousjulkaisu</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">numeerinen tieto</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='e'">
 <genre authority="marc">tietokanta</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='f'">
 <genre authority="marc">kirjasinlaji</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='g'">
 <genre authority="marc">peli</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 <xsl:if test="$typeOf008='BK'">
 <xsl:if test="substring($controlField008,25,1)='j'">
 <genre authority="marc">patentti</genre>
 </xsl:if>
 <xsl:if test="substring($controlField008,31,1)='1'">
 <genre authority="marc">juhlajulkaisu</genre>
 </xsl:if>
 <xsl:variable name="controlField008-34" select="substring($controlField008,35,1)"/>
 <xsl:if test="$controlField008-34='a' or $controlField008-34='b' or $controlField008-34='c' or $controlField008-34='d'">
 <genre authority="marc">elämäkerta</genre>
 </xsl:if>
 <xsl:variable name="controlField008-33" select="substring($controlField008,34,1)"/>
 <xsl:choose>
 <xsl:when test="$controlField008-33='e'">
 <genre authority="marc">essee</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='d'">
 <genre authority="marc">draama</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='c'">
 <genre authority="marc">sarjakuva</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='l'">
 <genre authority="marc">kaunokirjallisuus</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='h'">
 <genre authority="marc">huumori, satiiri</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">kirje</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='f'">
 <genre authority="marc">romaani</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='j'">
 <genre authority="marc">novelli</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='s'">
 <genre authority="marc">puhe, esitelmä</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">kansantarina</genre>
 </xsl:if>
 ...
 <genre authority="marc">muistelma</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'p')">
 <genre authority="marc">runo</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'r')">
 <genre authority="marc">harjoitus ilman musiikkia</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'g')">
 <genre authority="marc">esittely, reportaasi</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'s')">
 <genre authority="marc">ääni</genre>
 </xsl:if>
 ...
 <genre authority="marc">taideteos, alkuperäinen</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='b'">
 <genre authority="marc">moniviestin</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='c'">
 <genre authority="marc">taidejäljennös</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='d'">
 <genre authority="marc">dioraama</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='f'">
 <genre authority="marc">raina</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='g'">
 <genre authority="marc">artikla, pykälä</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">kuva</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='k'">
 <genre authority="marc">grafiikka</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='l'">
 <genre authority="marc">tekninen piirustus</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='m'">
 <genre authority="marc">elokuva</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='n'">
 <genre authority="marc">kaavio</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='o'">
 <genre authority="marc">sana- tai kuvakortti</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='p'">
 <genre authority="marc">mikroskoopin preparaatti</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='q' or marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='q']">
 <genre authority="marc">malli</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='r'">
 <genre authority="marc">esine</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='s'">
 <genre authority="marc">dia</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='t'">
 <genre authority="marc">kalvo</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='v'">
 <genre authority="marc">videotallenne</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='w'">
 <genre authority="marc">lelu</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <place>
 <placeTerm>
 <xsl:attribute name="type">koodi</xsl:attribute>
 ...
 <place>
 <placeTerm>
 <xsl:attribute name="type">teksti</xsl:attribute>
 ...
 <issuance>
 <xsl:choose>
 <xsl:when test="$leader7='a' or $leader7='c' or $leader7='d' or $leader7='m'">monografia</xsl:when>
 <xsl:when test="$leader7='b' or $leader7='i' or $leader7='s'">jatkuva</xsl:when>
 </xsl:choose>
 </issuance>
 </xsl:for-each>
 ...
 <digitalOrigin>digitoitu</digitalOrigin>
 </xsl:if>
 ...
 <form authority="marcform">pistekirjoitus</form>
 </xsl:when>
 ...
 <form authority="marcform">painotuote</form>
 </xsl:when>
 <xsl:when test="$leader6 = 'm' or ($check008-23 and $controlField008-23='s') or ($check008-29 and $controlField008-29='s')">
 <form authority="marcform">elektroninen</form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='b') or ($check008-29 and $controlField008-29='b')">
 <form authority="marcform">mikrokortti</form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='a') or ($check008-29 and $controlField008-29='a')">
 <form authority="marcform">mikrofilmi</form>
 </xsl:when>
 </xsl:choose>
 <!-- 1/04 fix -->
 ...
 <reformattingQuality>pääsy</reformattingQuality>
 </xsl:when>
 <xsl:when test="substring(text(),14,1)='p'">
 <reformattingQuality>säilytys</reformattingQuality>
 </xsl:when>
 <xsl:when test="substring(text(),14,1)='r'">
 <reformattingQuality>seuraaja</reformattingQuality>
 </xsl:when>
 </xsl:choose>
 </xsl:for-each>
 ...
 <targetAudience authority="marctarget">lukioikäiset tai vastaavat</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='e'">
 <targetAudience authority="marctarget">aikuiset</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='g'">
 <targetAudience authority="marctarget">yleinen</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='b' or $controlField008-22='c' or $controlField008-22='j'">
 <targetAudience authority="marctarget">nuoret</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='a'">
 <targetAudience authority="marctarget">esikoulu</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='f'">
 <targetAudience authority="marctarget">erikoistunut</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <identifier>
 <xsl:call-template name="isInvalid"/>
 <xsl:attribute name="type"><xsl:choose><xsl:when test="@ind1=0">julkaisun numero</xsl:when><xsl:when test="@ind1=1">matrix number</xsl:when><xsl:when test="@ind1=2">musiikkilevy</xsl:when><xsl:when test="@ind1=3">musiikkikustantaja</xsl:when><xsl:when test="@ind1=4">videotallenteen tunnus</xsl:when></xsl:choose></xsl:attribute>
 <xsl:call-template name="subfieldSelect">
 ...
 <xsl:attribute name="invalid">kyllä</xsl:attribute>
 </xsl:if>
 </xsl:template>
 ...
 <xsl:attribute name="script"><xsl:choose><xsl:when test="$scriptCode='(3'">arabia</xsl:when><xsl:when test="$scriptCode='(B'">latina</xsl:when><xsl:when test="$scriptCode='$1'">kiina, japani, korea</xsl:when><xsl:when test="$scriptCode='(N'">kyrillinen</xsl:when><xsl:when test="$scriptCode='(2'">heprea</xsl:when><xsl:when test="$scriptCode='(S'">kreikka</xsl:when></xsl:choose></xsl:attribute>
 </xsl:template>
 ...
 <language>
 <xsl:if test="@code!='a'">
 <xsl:attribute name="objectPart"><xsl:choose><xsl:when test="@code='b'">yhteenveto tai alaotsikko</xsl:when><xsl:when test="@code='d'">laulettu tai puhuttu teksti</xsl:when><xsl:when test="@code='e'">libretto</xsl:when><xsl:when test="@code='f'">sisällysluettelo</xsl:when><xsl:when test="@code='g'">liiteaineiston kieli</xsl:when><xsl:when test="@code='h'">käännös</xsl:when></xsl:choose></xsl:attribute>
 </xsl:if>
 <languageTerm authority="iso639-2b" type="code">
