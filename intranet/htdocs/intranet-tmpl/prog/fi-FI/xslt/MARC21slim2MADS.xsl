...
-->
 ...
 <xsl:text>suoraan</xsl:text>
 </xsl:attribute>
 </xsl:when>
 <xsl:when test="$controlField008-06='i'">
 <xsl:attribute name="geographicSubdivision">
 <xsl:text>välillinen</xsl:text>
 </xsl:attribute>
 </xsl:when>
 <xsl:when test="$controlField008-06='n'">
 <xsl:attribute name="geographicSubdivision">
 <xsl:text>ei sovellettavissa</xsl:text>
 </xsl:attribute>
 </xsl:when>
 </xsl:choose>
 ...
 <mads:recordInfo>
 <mads:recordOrigin>Konvertoitu MARCXML:stä MADS-versioon 2.0 (Revision 2.10)</mads:recordOrigin>
 <!-- <xsl:apply-templates select="marc:datafield[@tag=024]"/> -->
 ...
 <xsl:text>aikaisemmat säännöt</xsl:text>
 </mads:descriptionStandard>
 </xsl:if>
 ...
 <mads:descriptionStandard>
 <xsl:text>aacr2-yhteensopiva</xsl:text>
 </mads:descriptionStandard>
 </xsl:if>
 <xsl:if test="substring(.,11,1)='z'">
 <mads:descriptionStandard>
 <xsl:text>muut säännöt</xsl:text>
 </mads:descriptionStandard>
 </xsl:if>
 </xsl:for-each>
 </mads:recordInfo>
...
-->
 ...
 <xsl:attribute name="type">ei-julkinen</xsl:attribute>
 </xsl:when>
 <xsl:when test="@tag=670">
 <xsl:attribute name="type">lähde</xsl:attribute>
 </xsl:when>
 ...
 <xsl:attribute name="type">esimerkki</xsl:attribute>
 </xsl:when>
 <xsl:when test="@tag=682">
 <xsl:attribute name="type">poistettu nimeketieto</xsl:attribute>
 </xsl:when>
 <xsl:when test="@tag=688">
 <xsl:attribute name="type">sovellushistoria</xsl:attribute>
 </xsl:when>
 </xsl:choose>
 <xsl:call-template name="chopPunctuation">
 <xsl:with-param name="chopString">
 ...
 <xsl:attribute name="type">aikaisempi</xsl:attribute>
 </xsl:if>
 <xsl:if test="substring(marc:subfield[@code='w'],1,1)='b'">
 <xsl:attribute name="type">myöhemmin</xsl:attribute>
 </xsl:if>
 ...
 <xsl:attribute name="type">laajempi</xsl:attribute>
 </xsl:if>
 <xsl:if test="substring(marc:subfield[@code='w'],1,1)='h'">
 <xsl:attribute name="type">kapeampi</xsl:attribute>
 </xsl:if>
 <xsl:if test="substring(marc:subfield[@code='w'],1,1)='r'">
 <xsl:attribute name="type">muu</xsl:attribute>
 </xsl:if>
 ...
 <xsl:otherwise>
 <!-- 7xx -->
 <xsl:attribute name="type">vastaava</xsl:attribute>
 </xsl:otherwise>
 </xsl:choose>
 <xsl:apply-templates select="marc:subfield[@code='i']"/>
 </xsl:template>
 ...
 <xsl:attribute name="type">akronyymi</xsl:attribute>
 </xsl:if>
 ...
 <xsl:attribute name="authority">käteinen</xsl:attribute>
 </xsl:when>
 <xsl:when
