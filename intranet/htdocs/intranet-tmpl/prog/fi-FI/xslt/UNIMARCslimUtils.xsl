...
<xsl:stylesheet version="1.0"
 ...
 <span class="label">Julkaisu: </span>
 ...
 <xsl:attribute name="title">Hae julkaisijaa</xsl:attribute>
 <xsl:value-of select="."/>
 </a>
 <xsl:if test="position() != last()">
 <xsl:text>, </xsl:text>
 ...
 <xsl:when test="@ind2=3">Valmistaja: </xsl:when>
 ...
 <xsl:otherwise>Julkaisu: </xsl:otherwise>
 </xsl:choose>
 </span>
 <span>
 <xsl:call-template name="addClassRtl" />
