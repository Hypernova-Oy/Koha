...
<xsl:stylesheet version="1.0" xmlns:xlink="http://www.w3.org/TR/xlink" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns="http://www.loc.gov/mods/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="marc">
 ...
 <name>
 <xsl:if test="@ind1=1">
 <xsl:attribute name="type">henkilökohtainen</xsl:attribute>
 </xsl:if>
 <namePart>
 ...
 <xsl:when test="$leader6='i' or $leader6='j'">äänitallenne</xsl:when>
 ...
 <form><controlled>pistekirjoitus</controlled></form>
 </xsl:when>
 <xsl:when test="$leader6 = 'm' or ($check008-23 and $controlField008-23='s') or ($check008-29 and $controlField008-29='s')">
 <form><controlled>elektroninen</controlled></form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='b') or ($check008-29 and $controlField008-29='b')">
 <form><controlled>mikrokortti</controlled></form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='a') or ($check008-29 and $controlField008-29='a')">
 <form><controlled>mikrofilmi</controlled></form>
 </xsl:when>
 </xsl:choose>
 ...
 <targetAudience>lukioikäiset tai vastaavat</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='e'">
 <targetAudience>aikuiset</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='g'">
 <targetAudience>yleinen</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='b' or $controlField008-22='c' or $controlField008-22='j'">
 <targetAudience>nuoret</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='a'">
 <targetAudience>esikoulu</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='f'">
 <targetAudience>erikoistunut</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <xsl:choose>
 <xsl:when test="@ind1=0">julkaisun numero</xsl:when>
 <xsl:when test="@ind1=1">matrix number</xsl:when>
 <xsl:when test="@ind1=2">musiikkilevy</xsl:when>
 <xsl:when test="@ind1=3">musiikkikustantaja</xsl:when>
 <xsl:when test="@ind1=4">videotallenteen tunnus</xsl:when>
 </xsl:choose>
 </xsl:attribute>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">ab</xsl:with-param>
...
-->
 ...
 <xsl:otherwise>liittyvä</xsl:otherwise>
 </xsl:choose>
 </xsl:attribute>
 </xsl:template>
