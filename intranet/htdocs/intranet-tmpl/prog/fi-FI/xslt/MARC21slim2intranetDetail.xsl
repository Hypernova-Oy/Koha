...
<xsl:stylesheet version="1.0"
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'">Moniosainen julkaisu</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'">Teksti</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'">
 <xsl:choose>
 <xsl:when test="substring($controlField008,22,1)!='m'">Jatkuva julkaisu</xsl:when>
 <xsl:otherwise>Sarjajulkaisu</xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'">Artikkeli</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'">Teksti</xsl:when>
 <xsl:when test="$leader6='o'">Moniviestin</xsl:when>
 <xsl:when test="$leader6='p'">Sekalaiset aineistot</xsl:when>
 <xsl:when test="$leader6='m'">Elektroninen aineisto</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'">Kartta</xsl:when>
 <xsl:when test="$leader6='g'">Filmi</xsl:when>
 <xsl:when test="$leader6='k'">Kuva</xsl:when>
 <xsl:when test="$leader6='r'">ID-tunnus</xsl:when>
 <xsl:when test="$leader6='j'">Musiikki</xsl:when>
 <xsl:when test="$leader6='i'">Ääni</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'">Nuotti</xsl:when>
 </xsl:choose>
 </xsl:variable>
 ...
 <span class="results_summary type"><span class="label">Aineistotyyppi: </span>
 ...
 <span class="label">Osakohteet: </span>
 <a>
 <xsl:choose>
 ...
 <xsl:text>Näytä osakohteet</xsl:text>
 </a>
 </xsl:element>
 </xsl:if>
 ...
 <span class="results_summary volumes"><span class="label">Numerot: </span>
 <a>
 <xsl:choose>
 <xsl:when test="$UseControlNumber = '1' and marc:controlfield[@tag=001]">
 ...
 <xsl:text>Näytä niteet</xsl:text>
 </a>
 </span>
 </xsl:if>
 ...
 <span class="results_summary set"><span class="label">Moniosainen julkaisu: </span>
 ...
 <xsl:with-param name="label">Painos: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>

 <xsl:if test="marc:datafield[@tag=250]">
 <span class="results_summary edition"><span class="label">Painos: </span>
 ...
 <xsl:with-param name="label">Kuvaus: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>
 ...
 <span class="label">Mediatyyppi: </span>
 ...
 <span class="label">Tallennetyyppi: </span>
 ...
 <span class="label">Patenttinumero: </span>
 ...
 <span class="label">Raportin nro: </span>
 ...
 <span class="results_summary other_title"><span class="label">Muut nimekkeet: </span>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0"> [Nimekkeen osa]</xsl:when>
 <xsl:when test="@ind2=1"> [Rinnakkaisnimeke]</xsl:when>
 <xsl:when test="@ind2=2"> [Erottuva nimeke]</xsl:when>
 <xsl:when test="@ind2=3"> [Muu nimeke]</xsl:when>
 <xsl:when test="@ind2=4"> [Kansinimeke]</xsl:when>
 <xsl:when test="@ind2=5"> [Nimeke lisätyllä nimiösivulla]</xsl:when>
 <xsl:when test="@ind2=6"> [Otsikkonimeke]</xsl:when>
 <xsl:when test="@ind2=7"> [Juokseva nimeke]</xsl:when>
 <xsl:when test="@ind2=8"> [Selkänimeke]</xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <span class="results_summary translated_title"><span class="label">Nimekkeen käännös: </span>
 ...
 <xsl:with-param name="label">Yhtenäistetty nimeke: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>

 <xsl:if test="marc:datafield[@tag=130]|marc:datafield[@tag=240]|marc:datafield[@tag=730][@ind2!=2]">
 <span class="results_summary uniform_title"><span class="label">Yhtenäistetyt nimekkeet: </span>
 ...
 <span class="results_summary related_works"><span class="label">Liittyvät työt: </span>
 ...
 <span class="results_summary contained_works"><span class="label">Sisältyvät teokset: </span>
 ...
 <span class="results_summary subjects"><span class="label">Asiasanat: </span>
 ...
 <span class="results_summary genre"><span class="label">Genre/Muoto: </span>
 ...
 <xsl:with-param name="delimeter"> AND </xsl:with-param>
 <xsl:with-param name="prefix">(hakutermi-lajityyppi<xsl:value-of select="$SubjectModifier"/>:<xsl:value-of select="$TracingQuotesLeft"/></xsl:with-param>
 <xsl:with-param name="suffix"><xsl:value-of select="$TracingQuotesRight"/>)</xsl:with-param>
 <xsl:with-param name="urlencode">1</xsl:with-param>
 </xsl:call-template>
 </xsl:attribute>
...
<!-- MARC21 776 Additional Physical Form Entry -->
 ...
 <span class="label">Useita ulkoasuja: </span>
...
<!-- MARC21 777 - Issued With Entry -->
 ...
 <xsl:otherwise>
 <xsl:text>Kanssajulkaisu:</xsl:text>
 </xsl:otherwise>
 </xsl:choose>
 <xsl:text> </xsl:text>
 </span>
...
<!-- DDC classification -->
 ...
 <span class="label">DDC-luokitus: </span>
...
<!-- LOC classification -->
 ...
 <span class="label">LOC-luokitus: </span>
...
<!-- NLM classification -->
 ...
 <span class="label">NLM-luokitus: </span>
...
<!-- Other classification -->
 ...
 <span class="results_summary online_resources"><span class="label">Linkit: </span>
 ...
 <span class="label">Sisältö:</span>
 </xsl:when>
 <xsl:when test="marc:datafield[@tag=505]/@ind1=1">
 <span class="label">Puutteellinen sisältö:</span>
 </xsl:when>
 <xsl:when test="marc:datafield[@tag=505]/@ind1=2">
 <span class="label">Osittainen sisältö:</span>
 </xsl:when>
 </xsl:choose>
 ...
 <span class="label">Palkinnot: </span>
 </xsl:if>
 ...
 <span class="label">Tuotantoon osallistujat: </span>
 ...
 <span class="label">Huomautus toimenpiteistä: </span>
 ...
 <span class="label">
 <xsl:choose>
 <xsl:when test="@ind1=0"><xsl:text>Aihe: </xsl:text></xsl:when>
 <xsl:when test="@ind1=1"><xsl:text>Arvio: </xsl:text></xsl:when>
 <xsl:when test="@ind1=2"><xsl:text>Näkökulma ja sisältö: </xsl:text></xsl:when>
 <xsl:when test="@ind1=3"><xsl:text>Tiivistelmä: </xsl:text></xsl:when>
 <xsl:when test="@ind1=4"><xsl:text>Sisältöohje: </xsl:text></xsl:when>
 <xsl:otherwise><xsl:text>Yhteenveto: </xsl:text></xsl:otherwise>
 </xsl:choose>
 </span>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">abc</xsl:with-param>
 ...
 <span class="results_summary holdings_note basic_bibliographic_unit"><span class="label">Kokoelmat: </span>
 ...
 <span class="results_summary holdings_note supplementary_material"><span class="label">Suplementit: </span>
 ...
 <span class="results_summary holdings_note indexes"><span class="label">Indeksit: </span>
 ...
 <span class="label">Käännös teoksesta: </span>
 </xsl:when>
 <xsl:otherwise>
 <span class="label">
 <xsl:value-of select="marc:subfield[@code='i']"/>
 ...
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">hieman</xsl:with-param>
 <xsl:with-param name="delimeter">, </xsl:with-param>
 </xsl:call-template>
 </xsl:variable>
 <xsl:choose>
 ...
 <span class="results_summary supplement"><span class="label">Suplementti: </span>
 ...
 <span class="results_summary supplement_parent"><span class="label">Liittyy julkaisuun: </span>
 ...
 <span class="results_summary other_editions"><span class="label">Muu painos: </span>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0">
 <span class="label">Jatkaa julkaisua:</span>
 </xsl:when>
 <xsl:when test="@ind2=1">
 <span class="label">Jatkaa osittain julkaisua:</span>
 </xsl:when>
 <xsl:when test="@ind2=2">
 <span class="label">Korvaa julkaisun:</span>
 </xsl:when>
 ...
 <span class="label">Julkaisuun on osittain sulautunut:</span>
 </xsl:when>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0">
 <span class="label">Jatkuu nimellä:</span>
 </xsl:when>
 <xsl:when test="@ind2=1">
 <span class="label">Jatkuu osittain nimellä:</span>
 </xsl:when>
 <xsl:when test="@ind2=2">
 <span class="label">Korvattu nimellä:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">Korvattu osittain nimellä:</span>
 </xsl:when>
 <xsl:when test="@ind2=4">
 <span class="label">Sulautunut julkaisuun:</span>
 </xsl:when>
 <xsl:when test="@ind2=5">
 <span class="label">Sulautunut osittain julkaisuun:</span>
 </xsl:when>
 <xsl:when test="@ind2=6">
 <span class="label">Jakautunut julkaisuiksi:</span>
 </xsl:when>
 <xsl:when test="@ind2=7">
 <span class="label">Yhdistynyt julkaisuun ... ja muodostanut julkaisun ...</span>
 </xsl:when>
 ...
 <span class="results_summary other_relationship_entry"><span class="label">Muut vastaavat työt: </span>
 ...
 <span class="label">Verkkokirjasto: </span>
 Ei näytetä verkkokirjastossa </span>
 </xsl:when>
 <xsl:otherwise>
 <xsl:if test="$OPACBaseURL!=''">
 <span class="results_summary opac_view"><span class="label">Verkkokirjasto: </span>
 <a><xsl:attribute name="href"><xsl:value-of select="$OPACBaseURL"/>/cgi-bin/koha/opac-detail.pl?biblionumber=<xsl:value-of select="str:encode-uri(marc:datafield[@tag=999]/marc:subfield[@code='c'], true())"/></xsl:attribute><xsl:attribute name="target">_blank</xsl:attribute>Avaa uudessa ikkunassa</a>.
 </span>
 </xsl:if>
 </xsl:otherwise>
 </xsl:choose>
 ...
 <!-- #13383 -->
 <xsl:when test="@tag&lt;700"><span class="byAuthor">Tekijä(t): </span></xsl:when>
 <!--#13382 Changed Additional author to contributor -->
 <xsl:otherwise>Muu(t) tekijä(t): </xsl:otherwise>
 </xsl:choose>
 <a>
 <xsl:choose>
 <xsl:when test="marc:subfield[@code=9] and $UseAuthoritiesForTracings='1'">
 ...
 <xsl:with-param name="chopString">
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">fghiklmnoprstux</xsl:with-param>
 </xsl:call-template>
 </xsl:with-param>
 </xsl:call-template>
 </span>
 ...
 <xsl:attribute name="title">Näytä auktoriteettitietue</xsl:attribute>
 <xsl:attribute name="target">_blank</xsl:attribute>
 <xsl:element name="i">
 <xsl:attribute name="class">fa fa-search</xsl:attribute>
 <xsl:attribute name="aria-label">Näytä auktoriteettitietue</xsl:attribute>
 </xsl:element>
 </a>
 </xsl:template>
