 ...
 * Pitfalls:
 ...
 <span class="label">Tuottaja: </span>
 </xsl:when>
 <xsl:when test="$ind2='1'">
 <span class="label">Julkaisutiedot: </span>
 </xsl:when>
 <xsl:when test="$ind2='2'">
 <span class="label">Jakaja: </span>
 </xsl:when>
 <xsl:when test="$ind2='3'">
 <span class="label">Valmistaja: </span>
 </xsl:when>
 <xsl:when test="$ind2='4'">
 <span class="label">Tekijänoikeusvuosi: </span>
 </xsl:when>
 </xsl:choose>
 ...
 <xsl:with-param name="langLabel">Kieli: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='b']"/>
 <xsl:with-param name="langLabel">Yhteenvedon kieli: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='d']"/>
 <xsl:with-param name="langLabel">Puhuttu kieli: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='h']"/>
 <xsl:with-param name="langLabel">Alkuperäinen kieli: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='j']"/>
 <xsl:with-param name="langLabel">Tekstityksen kieli: </xsl:with-param>
 </xsl:call-template>
 </span>
 </xsl:for-each>
 </xsl:if>
 ...
 <span class="results_summary series"><span class="label">Sarja: </span>
 <!-- 440 -->
 ...
 <span class="label">Sisältövaroitus: </span>
