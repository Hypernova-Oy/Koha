...
-->
 ...
 <p class="author"><span class="byAuthor">av </span>
...
<xsl:if test="$DisplayIconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img alt="bok" class="materialtype" src="/intranet-tmpl/prog/img/famfamfam/silk/book_link.png" title="bok" /> Ställ in</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'"><img alt="bok" class="materialtype mt_icon_BK" src="/intranet-tmpl/prog/img/famfamfam/silk/book.png" title="bok" /> Text</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'"><img alt="periodika" class="materialtype mt_icon_CR" src="/intranet-tmpl/prog/img/famfamfam/silk/newspaper.png" title="periodika" /> Periodika</xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/book_open.png" alt="article" title="article" class="materialtype mt_icon_AR"/> Artikel</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'"><img alt="bok" class="materialtype mt_icon_BK" src="/intranet-tmpl/prog/img/famfamfam/silk/book.png" title="bok" /> Text</xsl:when>
 ...
 <xsl:when test="$leader6='m'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/computer_link.png" alt="computer file" title="computer file" class="materialtype mt_icon_CF"/> Datafil</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'"><img alt="karta" class="materialtype mt_icon_MP" src="/intranet-tmpl/prog/img/famfamfam/silk/map.png" title="karta" /> Karta </xsl:when>
 ...
 <xsl:when test="$leader6='k'"><img alt="Bild " class="materialtype mt_icon_GR" src="/intranet-tmpl/prog/img/famfamfam/silk/picture.png" /> Bild </xsl:when>
 <xsl:when test="$leader6='r'"><img alt="Objekt" class="materialtype mt_icon_OB" src="/intranet-tmpl/prog/img/famfamfam/silk/object.png" title="Objekt" /> Objekt</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'"><img src="/intranet-tmpl/prog/img/famfamfam/silk/music.png" alt="score" title="score" class="materialtype mt_icon_PR"/> Musiktryck</xsl:when>
 <xsl:when test="$leader6='i'"><img alt="ljud" class="materialtype mt_icon_MU" src="/intranet-tmpl/prog/img/famfamfam/silk/sound.png" title="ljud" /> Ljud</xsl:when>
 <xsl:when test="$leader6='j'"><img alt="musik" class="materialtype mt_icon_MU" src="/intranet-tmpl/prog/img/famfamfam/silk/sound.png" title="musik" /> Musik</xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
...
<xsl:text> </xsl:text> <!-- added blank space to fix font display problem, see Bug 3671 -->
 ...
 <span class="results_summary suppressed_opac">Dold i OPAC</span>
 </xsl:if>
 </xsl:if>
