...
-->
 ...
 <xsl:attribute name="collection">ja</xsl:attribute>
 </xsl:if>
 <xsl:if test="$leader6='d' or $leader6='f' or $leader6='p' or $leader6='t'">
 <xsl:attribute name="manuscript">ja</xsl:attribute>
 </xsl:if>
 <xsl:choose>
 <xsl:when test="$leader6='a' or $leader6='t'">text</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'">cartographic</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'">noterad musik</xsl:when>
 <xsl:when test="$leader6='i'">ljudinspelning-ej musik</xsl:when>
 <xsl:when test="$leader6='j'">ljudinspelning-musik</xsl:when>
 ...
 <genre authority="marc">karta</genre>
 </xsl:when>
 ...
 <genre authority="marc">databas</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='l'">
 <genre authority="marc">lösblad</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='m'">
 <genre authority="marc">serie</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='n'">
 <genre authority="marc">tidning</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='p'">
 <genre authority="marc">periodical</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='w'">
 <genre authority="marc">webbsida</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">abstrakt eller sammanfattning</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'b')">
 <genre authority="marc">bibliografi </genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'c')">
 <genre authority="marc">katalog</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'d')">
 <genre authority="marc">ordbok</genre>
 </xsl:when>
 ...
 <genre authority="marc">register</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'k')">
 <genre authority="marc">diskografi</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'l')">
 <genre authority="marc">lagstiftning</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'m')">
 <genre authority="marc">theses</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'n')">
 <genre authority="marc">litteraturundersökning</genre>
 </xsl:when>
 ...
 <genre authority="marc">filmografi</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'r')">
 <genre authority="marc">directory</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'s')">
 <genre authority="marc">statistik</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'t')">
 <genre authority="marc">teknisk rapport</genre>
 </xsl:when>
 ...
 <genre authority="marc">konferenspublikation</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">numeriska data</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='e'">
 <genre authority="marc">databas</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='f'">
 <genre authority="marc">typsnitt</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='g'">
 <genre authority="marc">spel</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">festskrift</genre>
 </xsl:if>
 <xsl:variable name="controlField008-34" select="substring($controlField008,35,1)"/>
 <xsl:if test="$controlField008-34='a' or $controlField008-34='b' or $controlField008-34='c' or $controlField008-34='d'">
 <genre authority="marc">biografi</genre>
 </xsl:if>
 ...
 <genre authority="marc">skönlitteratur</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='h'">
 <genre authority="marc">humor, satir</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">letter</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='f'">
 <genre authority="marc">roman</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='j'">
 <genre authority="marc">novell</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='s'">
 <genre authority="marc">tal</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">folksaga</genre>
 </xsl:if>
 ...
 <genre authority="marc">memoar</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'p')">
 <genre authority="marc">poesi</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'r')">
 <genre authority="marc">repetition</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'g')">
 <genre authority="marc">rapportering</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'s')">
 <genre authority="marc">ljud</genre>
 </xsl:if>
 ...
 <xsl:when test="$controlField008-33='f'">
 <genre authority="marc">filmremsa</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='g'">
 <genre authority="marc">legal article</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">bild</genre>
 </xsl:when>
 ...
 <genre authority="marc">film</genre>
 </xsl:when>
 ...
 <genre authority="marc">modell</genre>
 </xsl:when>
 ...
 <genre authority="marc">videoinspelning</genre>
 </xsl:when>
 ...
 <issuance>
 <xsl:choose>
 <xsl:when test="$leader7='a' or $leader7='c' or $leader7='d' or $leader7='m'">monografisk</xsl:when>
 ...
 <form authority="marcform">punktskrift</form>
 </xsl:when>
 ...
 <form authority="marcform">elektronisk</form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='b') or ($check008-29 and $controlField008-29='b')">
 <form authority="marcform">mikrofiche</form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='a') or ($check008-29 and $controlField008-29='a')">
 <form authority="marcform">mikrofilm</form>
 </xsl:when>
 </xsl:choose>
 <!-- 1/04 fix -->
 ...
 <targetAudience authority="marctarget">ungdom</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='e'">
 <targetAudience authority="marctarget">vuxen</targetAudience>
 </xsl:when>
 ...
 <targetAudience authority="marctarget">specialiserad</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <identifier>
 <xsl:call-template name="isInvalid"/>
 <xsl:attribute name="type"><xsl:choose><xsl:when test="@ind1=0">exemplar nummer</xsl:when><xsl:when test="@ind1=1">matrisnummer</xsl:when><xsl:when test="@ind1=2">music plate</xsl:when><xsl:when test="@ind1=3">musikförläggare</xsl:when><xsl:when test="@ind1=4">videorecording identifier</xsl:when></xsl:choose></xsl:attribute>
 <xsl:call-template name="subfieldSelect">
 ...
 <xsl:attribute name="invalid">ja</xsl:attribute>
 </xsl:if>
 </xsl:template>
 ...
 <xsl:attribute name="script"><xsl:choose><xsl:when test="$scriptCode='(3'">Arabiska</xsl:when><xsl:when test="$scriptCode='(B'">Latin</xsl:when><xsl:when test="$scriptCode='$1'">Kinesiska, japanska, koreanska</xsl:when><xsl:when test="$scriptCode='(N'">Kyrilliska </xsl:when><xsl:when test="$scriptCode='(2'">Hebreiska</xsl:when><xsl:when test="$scriptCode='(S'">Grekisk </xsl:when></xsl:choose></xsl:attribute>
 </xsl:template>
 ...
 <language>
 <xsl:if test="@code!='a'">
 <xsl:attribute name="objectPart"><xsl:choose><xsl:when test="@code='b'">summary or subtitle</xsl:when><xsl:when test="@code='d'">sjungen eller talad text</xsl:when><xsl:when test="@code='e'">libretto</xsl:when><xsl:when test="@code='f'">table of contents</xsl:when><xsl:when test="@code='g'">medföljande material</xsl:when><xsl:when test="@code='h'">översättning</xsl:when></xsl:choose></xsl:attribute>
 </xsl:if>
 <languageTerm authority="iso639-2b" type="code">
