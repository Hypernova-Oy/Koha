...
<xsl:stylesheet version="1.0"
 ...
 <span class="label">Publicering: </span>
 ...
 <xsl:attribute name="title">Sök utgivare</xsl:attribute>
 <xsl:value-of select="."/>
 </a>
 <xsl:if test="position() != last()">
 <xsl:text>, </xsl:text>
 ...
 <xsl:otherwise>Publicering: </xsl:otherwise>
 </xsl:choose>
 </span>
 <span>
 <xsl:call-template name="addClassRtl" />
 ...
 <span class="label">Länkad till:</span>
 <span class="value">
 <xsl:call-template name="addClassRtl" />
