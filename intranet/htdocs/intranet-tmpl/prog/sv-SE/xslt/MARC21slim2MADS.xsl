...
-->
 ...
 <xsl:attribute name="geographicSubdivision">
 <xsl:text>ej tillämpligt</xsl:text>
 </xsl:attribute>
 </xsl:when>
 </xsl:choose>
 ...
 <mads:recordInfo>
 <mads:recordOrigin>Konverterad från MARCXML till MADS version 2.0 (Revision 2.10)</mads:recordOrigin>
 <!-- <xsl:apply-templates select="marc:datafield[@tag=024]"/> -->
 ...
 <mads:descriptionStandard>
 <xsl:text>aacr2-kompatibel</xsl:text>
 </mads:descriptionStandard>
 </xsl:if>
...
-->
 ...
 <xsl:attribute name="type">källa</xsl:attribute>
 </xsl:when>
 ...
 <xsl:attribute name="type">tidigare</xsl:attribute>
 </xsl:if>
 ...
 <xsl:attribute name="type">akronym</xsl:attribute>
 </xsl:if>
