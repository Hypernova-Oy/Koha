 ...
 * Pitfalls:
 ...
 <span class="label">Utgivningsuppgift: </span>
 </xsl:when>
 <xsl:when test="$ind2='2'">
 <span class="label">Distributör: </span>
 </xsl:when>
 <xsl:when test="$ind2='3'">
 <span class="label">Tillverkare: </span>
 </xsl:when>
 <xsl:when test="$ind2='4'">
 <span class="label">Datum för upphovsrätt: </span>
 </xsl:when>
 </xsl:choose>
 ...
 <xsl:with-param name="langLabel">Språk: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='b']"/>
 <xsl:with-param name="langLabel">Språk på sammanfattning: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='d']"/>
 <xsl:with-param name="langLabel">Talat språk: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='h']"/>
 <xsl:with-param name="langLabel">Originalspråk: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='j']"/>
 <xsl:with-param name="langLabel">Språk på undertitel: </xsl:with-param>
 </xsl:call-template>
 </span>
 </xsl:for-each>
 </xsl:if>
 ...
 <span class="results_summary series"><span class="label">Serie: </span>
 <!-- 440 -->
 ...
 <span class="label">Innehållsvarning: </span>
 ...
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">bcdefghijklmnopqrstuvwxyz</xsl:with-param>
 </xsl:call-template>
