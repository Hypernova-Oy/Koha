...
<xsl:stylesheet version="1.0"
 ...
 <span class="results_summary other_title"><span class="label">Annan titel: </span>
 ...
 <xsl:with-param name="label">Föredragen titel: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>

 <xsl:if test="marc:datafield[@tag=130]|marc:datafield[@tag=240]|marc:datafield[@tag=730][@ind2!=2]">
 <span class="results_summary uniform_title"><span class="label">Originaltitel: </span>
 ...
 <span class="results_summary related_works"><span class="label">Relaterade verk: </span>
 ...
 <span class="results_summary contained_works"><span class="label">Inkluderade verk: </span>
 ...
 <span class="results_summary subjects"><span class="label">Ämnen: </span>
...
<!-- Other classification -->
 ...
 <span class="results_summary online_resources"><span class="label">Onlineresurser: </span>
 ...
 <span class="results_summary supplement"><span class="label">Bilaga: </span>
 ...
 <span class="results_summary supplement_parent"><span class="label">Bilaga till: </span>
 ...
 <span class="results_summary opac_view"><span class="label">OPAC-vy: </span>
 <a><xsl:attribute name="href"><xsl:value-of select="$OPACBaseURL"/>/cgi-bin/koha/opac-detail.pl?biblionumber=<xsl:value-of select="str:encode-uri(marc:datafield[@tag=999]/marc:subfield[@code='c'], true())"/></xsl:attribute><xsl:attribute name="target">_blank</xsl:attribute>Öppna i nytt fönster</a>.
 </span>
 </xsl:if>
 </xsl:otherwise>
 </xsl:choose>
