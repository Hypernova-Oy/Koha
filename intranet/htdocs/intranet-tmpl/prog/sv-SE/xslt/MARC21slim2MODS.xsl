...
<xsl:stylesheet version="1.0" xmlns:xlink="http://www.w3.org/TR/xlink" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns="http://www.loc.gov/mods/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="marc">
 ...
 <form><controlled>punktskrift</controlled></form>
 </xsl:when>
 <xsl:when test="$leader6 = 'm' or ($check008-23 and $controlField008-23='s') or ($check008-29 and $controlField008-29='s')">
 <form><controlled>elektronisk</controlled></form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='b') or ($check008-29 and $controlField008-29='b')">
 <form><controlled>mikrofiche</controlled></form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='a') or ($check008-29 and $controlField008-29='a')">
 <form><controlled>mikrofilm</controlled></form>
 </xsl:when>
 </xsl:choose>
 ...
 <targetAudience>ungdom</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='e'">
 <targetAudience>vuxen</targetAudience>
 </xsl:when>
 ...
 <targetAudience>specialiserad</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <xsl:choose>
 <xsl:when test="@ind1=0">exemplar nummer</xsl:when>
 <xsl:when test="@ind1=1">matrisnummer</xsl:when>
 <xsl:when test="@ind1=2">music plate</xsl:when>
 <xsl:when test="@ind1=3">musikförläggare</xsl:when>
