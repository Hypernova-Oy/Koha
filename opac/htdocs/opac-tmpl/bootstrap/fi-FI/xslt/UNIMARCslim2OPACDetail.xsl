...
<xsl:template match="marc:record">
 ...
 <xsl:with-param name="label">Auktorisoitu vakiintunut nimimuoto</xsl:with-param>
 ...
 <xsl:with-param name="label">Painoshuomautus:</xsl:with-param>
 <xsl:with-param name="spanclass">painos</xsl:with-param>
 </xsl:call-template>
