...
<xsl:stylesheet version="1.0"
 ...
 <xsl:choose>
 <xsl:when test="$materialTypeLabel='Book'">Kirja</xsl:when>
 <xsl:when test="$materialTypeLabel='Map'">Kartta</xsl:when>
 <xsl:when test="$materialTypeLabel='Music'">Musiikkialbumi</xsl:when>
 ...
 <xsl:attribute name="typeof"><xsl:value-of select='$schemaOrgType' /> Tuote</xsl:attribute>
 <xsl:attribute name="resource">#tietue</xsl:attribute>
 ...
 <xsl:with-param name="label">Yhtenäistetyt nimekkeet: </xsl:with-param>
 </xsl:call-template>
 </span>
 </xsl:if>
 ...
 <span class="label">Yhtenäistetyt nimekkeet: </span>
 <ul class="resource_list">
 ...
 <span class="label">Liittyvät työt: </span>
 <ul class="resource_list">
 ...
 <span class="label">Sisältyvät teokset: </span>
 <ul class="resource_list">
 ...
 <span class="label">Genre/Muoto: </span>
 <ul class="resource_list">
...
<!-- Other classification -->
 ...
 <span class="label">
 <xsl:if test="@ind1=1"><xsl:text>Esittäjät: </xsl:text></xsl:if>
 </span>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">a</xsl:with-param>
 </xsl:call-template>
 ...
 <span class="label">Suplementti: </span>
 <ul class="resource_list">
 ...
 <span class="label">Liittyy julkaisuun: </span>
 <ul class="resource_list">
 ...
 <xsl:text>Äänitiedosto</xsl:text>
 </a>
 </span>
 </xsl:if>
 ...
 <xsl:attribute name="class">muut tekijät</xsl:attribute>
 ...
 <xsl:otherwise><xsl:attribute name="property">tekijä</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:otherwise><xsl:attribute name="property">muu tekijä</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:otherwise><xsl:attribute name="typeof">Henkilö</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:otherwise><xsl:attribute name="typeof">Yhteisö</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <span property="name">
 <xsl:choose>
