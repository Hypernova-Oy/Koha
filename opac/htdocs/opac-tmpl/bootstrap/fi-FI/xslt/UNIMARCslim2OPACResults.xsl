...
<xsl:template match="marc:record">
 ...
 <span class="LabelCallNumber">Luokka: </span>
 ...
 <span>
 <xsl:attribute name="class">
 Yhteenveto <xsl:value-of select="translate(items:substatus,' ','_')"/>
 </xsl:attribute>
 ...
 <span class="unavailable">
 <xsl:text>Kuljetettavana (</xsl:text>
