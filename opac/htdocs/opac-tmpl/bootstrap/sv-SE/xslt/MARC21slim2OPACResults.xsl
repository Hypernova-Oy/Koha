...
-->
 ...
 tillgänglig online <img src="/opac-tmpl/lib/famfamfam/drive_web.png" alt="remote" class="format"/>
 </xsl:if>
 ...
 <img alt="noterad musik" class="format" src="/opac-tmpl/lib/famfamfam/script.png" />
 </xsl:if>
 ...
 <img alt="ljudskiva" class="format" src="/opac-tmpl/lib/famfamfam/cd.png" />
 </xsl:if>
 ...
 <img alt="storstil" class="format" src="/opac-tmpl/lib/famfamfam/magnifier.png" />
 </xsl:if>
...
-->
 ...
 <span class="byAuthor">av</span><xsl:text> </xsl:text>
...
<xsl:if test="$DisplayOPACiconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img alt="Ställ in" class="materialtype mt_icon_ST" src="/opac-tmpl/lib/famfamfam/ST.png" /> Ställ in</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 ...
 <xsl:when test="$leader7='i' or $leader7='s'"><img alt="Periodika" class="materialtype mt_icon_SE" src="/opac-tmpl/lib/famfamfam/SE.png" /> Periodika</xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'"><img alt="Artikel" class="materialtype mt_icon_AR" src="/opac-tmpl/lib/famfamfam/AR.png" /> Artikel</xsl:when>
 </xsl:choose>
 </xsl:when>
 ...
 <xsl:when test="$leader6='m'"><img alt="Datafil" class="materialtype mt_icon_CF" src="/opac-tmpl/lib/famfamfam/CF.png" /> Datafil</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'"><img alt="Karta " class="materialtype mt_icon_MP" src="/opac-tmpl/lib/famfamfam/MP.png" /> Karta </xsl:when>
 <xsl:when test="$leader6='g'"><img src="/opac-tmpl/lib/famfamfam/VM.png" alt="Film" class="materialtype mt_icon_VM"/> Film</xsl:when>
 <xsl:when test="$leader6='k'"><img alt="Bild " class="materialtype mt_icon_GR" src="/opac-tmpl/lib/famfamfam/GR.png" /> Bild </xsl:when>
 <xsl:when test="$leader6='r'"><img alt="Objekt" class="materialtype mt_icon_OB" src="/opac-tmpl/lib/famfamfam/OB.png" /> Objekt</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'"><img alt="Musiktryck" class="materialtype mt_icon_PR" src="/opac-tmpl/lib/famfamfam/PR.png" /> Musiktryck</xsl:when>
 <xsl:when test="$leader6='i'"><img alt="Ljud" class="materialtype mt_icon_MU" src="/opac-tmpl/lib/famfamfam/MU.png" /> Ljud</xsl:when>
 <xsl:when test="$leader6='j'"><img alt="Musik" class="materialtype mt_icon_PR" src="/opac-tmpl/lib/famfamfam/PR.png" /> Musik</xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
 ...
 <span class="label">; Typ av periodika: </span>
 </xsl:if>
 <xsl:choose>
 <xsl:when test="$controlField008-21='d'">
 <img alt="databas" class="format" src="/opac-tmpl/lib/famfamfam/database.png" />
 </xsl:when>
 ...
 <img alt="webbsida" class="format" src="/opac-tmpl/lib/famfamfam/world_link.png" />
 </xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
 ...
 <span class="label">; Typ av innehåll: </span>
 <xsl:choose>
 <xsl:when test="contains($controlField008-24,'a')">
 abstrakt eller sammanfattning </xsl:when>
 <xsl:when test="contains($controlField008-24,'b')">
 bibliografi<img alt="bibliografi " class="natureofcontents" src="/opac-tmpl/lib/famfamfam/text_list_bullets.png" />
 </xsl:when>
 ...
 lagstiftning </xsl:when>
 <xsl:when test="contains($controlField008-24,'m')">
 theses </xsl:when>
 <xsl:when test="contains($controlField008-24,'n')">
 litteraturundersökning </xsl:when>
 ...
 <img alt="teknisk rapport" class="natureofcontents" src="/opac-tmpl/lib/famfamfam/report.png" />
 </xsl:when>
 ...
 <span class="label">; Typ av datorfil:</span>
 </xsl:if>
 <xsl:choose>
 <xsl:when test="$controlField008-26='a'">
 numeriska data </xsl:when>
 <xsl:when test="$controlField008-26='e'">
 <img alt="databas" class="format" src="/opac-tmpl/lib/famfamfam/database.png" />
 </xsl:when>
 <xsl:when test="$controlField008-26='f'">
 <img alt="typsnitt" class="format" src="/opac-tmpl/lib/famfamfam/font.png" />
 </xsl:when>
 <xsl:when test="$controlField008-26='g'">
 <img alt="spel" class="format" src="/opac-tmpl/lib/famfamfam/controller.png" />
 </xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
 ...
 <img alt="biografi" class="natureofcontents" src="/opac-tmpl/lib/famfamfam/user.png" />
 </xsl:if>

 <xsl:if test="$controlField008-33 and $controlField008-33!='|' and $controlField008-33!='u' and $controlField008-33!=' '">
 <span class="label">; Litterär form:  </span>
 </xsl:if>
 <xsl:choose>
 ...
 Humor, satir, etc.</xsl:when>
 <xsl:when test="$controlField008-33='i'">
 Bokstäver</xsl:when>
 <xsl:when test="$controlField008-33='j'">
 Noveller </xsl:when>
 <xsl:when test="$controlField008-33='m'">
 Blandat format </xsl:when>
 ...
 <span class="label">; Litterär form:  </span> <!-- Literary text for sound recordings -->
 <xsl:if test="contains($controlField008-30-31,'b')">
 biografi</xsl:if>
 <xsl:if test="contains($controlField008-30-31,'c')">
 konferenspublikation </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'d')">
 drama </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'e')">
 essay </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'f')">
 skönlitteratur </xsl:if>
 ...
 <span class="label">; Typ av visuellt material:  </span>
 <xsl:choose>
...
<xsl:text> </xsl:text> <!-- added blank space to fix font display problem, see Bug 3671 -->
 ...
 <div class="results_summary publisher"><span class="label">Utgivningsinformation: </span>
 ...
 <span class="label">Översatt titel: </span>
 ...
 <status english="Checked out">Utlånad</status>
 <status english="Withdrawn">Återkallad</status>
 <status english="Lost">Förlorad</status>
 <status english="Damaged">Skadad</status>
 <status english="Pending hold">Reservation i kö</status>
 <status english="In transit">Under transport</status>
 <status english="Hold waiting">Reserverad</status>
 <status english="Recall waiting">Väntande återkrav</status>
 <status english="Not for loan">Ej för utlån</status>
 </xsl:variable>
 ...
 <xsl:otherwise><span class="noitems">Inga exemplar finns tillgängliga.</span> </xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 ...
 <span class="AvailabilityLabel"><strong><xsl:text>Exemplar tillgängliga för lån: </xsl:text></strong></span>
 ...
 <span class="AvailabilityLabel"><strong><xsl:text>Exemplar tillgängliga som referens:</xsl:text></strong></span>
 ...
 <span class="AvailabilityLabel"><strong><xsl:text>Ej tillgänglig: </xsl:text></strong></span>
 ...
 <xsl:if test="$OPACItemLocation='callnum'">Hyllsignatur: </xsl:if>
 <xsl:if test="$OPACItemLocation='ccode'">Avdelning, hyllsignatur: </xsl:if>
 <xsl:if test="$OPACItemLocation='location'">Placering, hyllsignum: </xsl:if>
 </span>
