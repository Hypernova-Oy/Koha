...
<xsl:template match="marc:record">
 ...
 <xsl:with-param name="label">Översättning av </xsl:with-param>
 <xsl:with-param name="spanclass">orginaltitel </xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_title">
 <xsl:with-param name="tag">461</xsl:with-param>
 <xsl:with-param name="label">Ställ in nivå</xsl:with-param>
 <xsl:with-param name="spanclass">set_level</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_title">
 <xsl:with-param name="tag">464</xsl:with-param>
 <xsl:with-param name="label">Styckeanalysnivå</xsl:with-param>
 <xsl:with-param name="spanclass">styckeanalysnivå</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_7xx">
 <xsl:with-param name="tag">700</xsl:with-param>
 <xsl:with-param name="label">Huvudförfattare </xsl:with-param>
 <xsl:with-param name="spanclass">huvudförfattare </xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_7xx">
 <xsl:with-param name="tag">710</xsl:with-param>
 <xsl:with-param name="label">Corporate Author (primär)</xsl:with-param>
 <xsl:with-param name="spanclass">corporate_main_author</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_7xx">
 <xsl:with-param name="tag">701</xsl:with-param>
 <xsl:with-param name="label">Medförfattare </xsl:with-param>
 <xsl:with-param name="spanclass">medförfattare </xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_7xx">
 <xsl:with-param name="tag">702</xsl:with-param>
 <xsl:with-param name="label">Sekundär författare</xsl:with-param>
 <xsl:with-param name="spanclass">underordnad författare</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_7xx">
 <xsl:with-param name="tag">711</xsl:with-param>
 <xsl:with-param name="label">Corporate Author (medförfattare)</xsl:with-param>
 <xsl:with-param name="spanclass">corporate_coauthor</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_7xx">
 <xsl:with-param name="tag">712</xsl:with-param>
 <xsl:with-param name="label">Corporate Author (sekundär)</xsl:with-param>
 <xsl:with-param name="spanclass">corporate_secondary_author</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_title">
 <xsl:with-param name="tag">500</xsl:with-param>
 <xsl:with-param name="label">Uniform titel </xsl:with-param>
 <xsl:with-param name="spanclass">uniform_titel</xsl:with-param>
 </xsl:call-template>
 ...
 <xsl:when test="@code='i'">av medföljande material, </xsl:when>
 ...
 <xsl:with-param name="label">Utgåvebeteckning</xsl:with-param>
 <xsl:with-param name="spanclass">utgåva </xsl:with-param>
 </xsl:call-template>
 ...
 <span class="label">Klassificering:</span>
 ...
 <span class="label">Innehållskommentar:</span>
 ...
 <span class="label">Sammandrag: </span>
 ...
 <span class="label">Ursprungsanteckning: </span>
 ...
 <span class="label">Bibliografi:</span>
 ...
 <span class="label">Avhandling: </span>
 ...
 <span class="label">SUDOC seriehistorik: </span>
 ...
 <xsl:with-param name="label">Ämne - personnamn</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">601</xsl:with-param>
 <xsl:with-param name="label">Ämne - Corporate Author</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">602</xsl:with-param>
 <xsl:with-param name="label">Ämne - familj</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">604</xsl:with-param>
 <xsl:with-param name="label">Ämne - Författare/Titel</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">606</xsl:with-param>
 <xsl:with-param name="label">Ämne - ämnesnamn</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">607</xsl:with-param>
 <xsl:with-param name="label">Ämne - geografiskt namn</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">608</xsl:with-param>
 <xsl:with-param name="label">Ämne - form</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">610</xsl:with-param>
 <xsl:with-param name="label">Ämne</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">615</xsl:with-param>
 <xsl:with-param name="label">Ämneskategori </xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">616</xsl:with-param>
 <xsl:with-param name="label">Varumärke </xsl:with-param>
 </xsl:call-template>

 <xsl:if test="marc:datafield[@tag=856]">
 <span class="results_summary online_resources">
 <span class="label">Elektroniska resurser:</span>
