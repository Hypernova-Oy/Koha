...
<xsl:template match="marc:record">
 ...
 Inga exemplar finns tillgängliga </xsl:when>
 ...
 <span class="LabelCallNumber">Hyllsignatur: </span>
 ...
 <span class="unavailable">
 <xsl:text>Under förflyttning (</xsl:text>
