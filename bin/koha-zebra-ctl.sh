...
LOGDIR=/build/koha-24.11.09/debian/tmp/var/log/koha
ERRLOG=$LOGDIR/koha-zebradaemon.err
STDOUT=$LOGDIR/koha-zebradaemon.log
OUTPUT=$LOGDIR/koha-zebradaemon-output.log
KOHA_CONF=/build/koha-24.11.09/debian/tmp/etc/koha/koha-conf.xml
RUNDIR=/build/koha-24.11.09/debian/tmp/var/run/koha/zebradb
LOCKDIR=/build/koha-24.11.09/debian/tmp/var/lock/koha/zebradb
